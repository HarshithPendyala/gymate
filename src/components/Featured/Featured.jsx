            ...
            <div className='container'>
                <div className='flex flex-col text-center items-center relative'>
                    ...
                    <img 
                        ...
                        />
                    <h2 className='text-[3.6rem] text-block font-bold my-10'>We are offering Best Flexible Classes</h2>
                </div>
        ...
        <div className='featured-cta flex justify-center text-left items-center md1000:bg-none md1000:bg-[#ff0336] '>
            <div className='container page-padding'>
                <div className='flex items-center md1000:flex-col md1000:gap-12 md1000:text-center'>
                    <h3 className='text-white font-bold text-[3.7rem] md1000:text-[3rem] max-w-6xl px-7 leading-[1.2] min450:text-[2.4rem]'>We are always providing best fitness services for you</h3>
                    <MainButton
                        color={`text-black`}
                        bg={`bg-white`}
                        text="Join With Us"
